...
public class Customer extends User{
    ...
    public Customer(String firstName, String lastName, Date birthDate, TYPES customerType) {
    ...
    public Ticket purchaseTicketUsingCase(String areaCode, Cost.PERIOD ticketType, int numberOfTicket){
        return Ticket.generateTicketByCash(areaCode,ticketType,numberOfTicket);
    }
    public Ticket purchaseTicketBankCard(String areaCode, Cost.PERIOD ticketType, int numberOfTicket, Card card){
        return Ticket.generateTicketByCard(areaCode,ticketType,numberOfTicket,card);
    }
}
